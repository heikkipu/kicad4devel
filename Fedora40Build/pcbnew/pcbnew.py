...
class BOARD_ITEM(EDA_ITEM):
    ...
    def RunOnChildren(self, aFunction):
        r"""RunOnChildren(BOARD_ITEM self, std::function< void (BOARD_ITEM *) > const & aFunction)"""
        return _pcbnew.BOARD_ITEM_RunOnChildren(self, aFunction)

    def RunOnDescendants(self, aFunction, aDepth=0):
        r"""RunOnDescendants(BOARD_ITEM self, std::function< void (BOARD_ITEM *) > const & aFunction, int aDepth=0)"""
        return _pcbnew.BOARD_ITEM_RunOnDescendants(self, aFunction, aDepth)
...
class ZONE_SETTINGS(object):
    ...
    def GetDoNotAllowCopperPour(self):
        r"""GetDoNotAllowCopperPour(ZONE_SETTINGS self) -> bool"""
...
class PCB_TEXTBOX(PCB_SHAPE, EDA_TEXT):
    ...
    def GetCornersInSequence(self):
        r"""GetCornersInSequence(PCB_TEXTBOX self) -> VECTOR_VECTOR2I"""
        return _pcbnew.PCB_TEXTBOX_GetCornersInSequence(self)
...
class PCB_TABLE(BOARD_ITEM_CONTAINER):
    ...
    def SetStrokeHeader(self, aDoStroke):
        r"""SetStrokeHeader(PCB_TABLE self, bool aDoStroke)"""
        return _pcbnew.PCB_TABLE_SetStrokeHeader(self, aDoStroke)

    def StrokeHeader(self):
        r"""StrokeHeader(PCB_TABLE self) -> bool"""
        return _pcbnew.PCB_TABLE_StrokeHeader(self)
...
class PCB_GROUP(BOARD_ITEM):
    ...
    def RunOnDescendants(self, aFunction, aDepth=0):
        r"""RunOnDescendants(PCB_GROUP self, std::function< void (BOARD_ITEM *) > const & aFunction, int aDepth=0)"""
        return _pcbnew.PCB_GROUP_RunOnDescendants(self, aFunction, aDepth)
...
class BOARD(BOARD_ITEM_CONTAINER):
    ...
    def RunOnDescendants(self, aFunction, aDepth=0):
        r"""RunOnDescendants(BOARD self, std::function< void (BOARD_ITEM *) > const & aFunction, int aDepth=0)"""
        return _pcbnew.BOARD_RunOnDescendants(self, aFunction, aDepth)
...
class FOOTPRINT(BOARD_ITEM_CONTAINER):
    ...
    def RunOnDescendants(self, aFunction, aDepth=0):
        r"""RunOnDescendants(FOOTPRINT self, std::function< void (BOARD_ITEM *) > const & aFunction, int aDepth=0)"""
        return _pcbnew.FOOTPRINT_RunOnDescendants(self, aFunction, aDepth)
    ...
    def SetComponentClass(self, aClass):
        r"""SetComponentClass(FOOTPRINT self, COMPONENT_CLASS const * aClass)"""
        return _pcbnew.FOOTPRINT_SetComponentClass(self, aClass)
