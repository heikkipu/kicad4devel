...
namespace PCBPLOTPARAMS_T
{
    ...
    enum T
    {
        ...
        T_crossoutdnponfab,
        T_dashed_line_dash_ratio,
        T_dashed_line_gap_ratio,
        T_disableapertmacros,
        T_drillshape,
        T_dxfimperialunits,
        T_dxfpolygonmode,
        T_dxfusepcbnewfont,
        ...
        T_pdf_front_fp_property_popups,
        T_pdf_metadata,
        T_pdf_single_document,
        T_plot_black_and_white,
        T_plot_on_all_layers_selection,
        T_plotfptext,
        T_plotframeref,
        T_plotinvisibletext,
        T_plotpadnumbers,
 ...
 *    /opt/kicad/program/master/Tears_Master/common/pcb_plot_params.keywords
 */
...
public:
     ...
     */
    PCBPLOTPARAMS_T::T GetCurStrAsToken()
    {
        return (PCBPLOTPARAMS_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
