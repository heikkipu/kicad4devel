...
#ifndef STROKE_PARAMS_LEXER_H_
#define STROKE_PARAMS_LEXER_H_
 ...
 *   typedef STROKEPARAMS_T::T T;
 * within that problem area.
 */
namespace STROKEPARAMS_T
{
 ...
 *    /opt/kicad/program/master/Tears_Master/common/stroke_params.keywords
 */
class KICOMMON_API STROKE_PARAMS_LEXER : public DSNLEXER
{
...
public:
     ...
     */
    STROKE_PARAMS_LEXER( LINE_READER* aLineReader ) :
     ...
     */
    static const char* TokenName( STROKEPARAMS_T::T aTok );
     ...
     * with another usage).
     * @return STROKEPARAMS_T::T - the type of token found next.
     * @throw IO_ERROR - only if the LINE_READER throws it.
     */
    STROKEPARAMS_T::T NextTok()
    {
        return (STROKEPARAMS_T::T) DSNLEXER::NextTok();
    }
     ...
     */
    STROKEPARAMS_T::T NeedSYMBOL()
    {
        return (STROKEPARAMS_T::T) DSNLEXER::NeedSYMBOL();
    }
     ...
     */
    STROKEPARAMS_T::T NeedSYMBOLorNUMBER()
    {
        return (STROKEPARAMS_T::T) DSNLEXER::NeedSYMBOLorNUMBER();
    }
     ...
     */
    STROKEPARAMS_T::T CurTok()
    {
        return (STROKEPARAMS_T::T) DSNLEXER::CurTok();
    }
     ...
     */
    STROKEPARAMS_T::T PrevTok()
    {
        return (STROKEPARAMS_T::T) DSNLEXER::PrevTok();
    }
     ...
     */
    STROKEPARAMS_T::T GetCurStrAsToken()
    {
        return (STROKEPARAMS_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
