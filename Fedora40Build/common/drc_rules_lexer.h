...
namespace DRCRULE_T
{
    ...
    enum T
    {
        ...
        T_connection_width,
        T_constraint,
        T_courtyard_clearance,
        T_creepage,
        T_diff_pair_gap,
        T_diff_pair_uncoupled,
        T_disallow,
        T_edge_clearance,
        T_error,
        T_exclusion,
        ...
        T_length,
        T_max,
        T_mechanical_clearance,
        T_mechanical_hole_clearance,
        T_micro_via,
        T_min,
        T_min_resolved_spokes,
        T_none,
        T_npth,
        T_opt,
        T_outer,
        T_pad,
        T_physical_clearance,
        T_physical_hole_clearance,
        T_pth,
        T_rule,
        T_severity,
        T_silk_clearance,
        ...
        T_text_height,
        T_text_thickness,
        T_thermal_relief_gap,
        T_thermal_reliefs,
        T_thermal_spoke_width,
        T_track,
        T_track_angle,
        T_track_segment_length,
        T_track_width,
        T_version,
        T_via,
        T_via_count,
 ...
 *    /opt/kicad/program/master/Tears_Master/common/drc_rules.keywords
 */
class KICOMMON_API DRC_RULES_LEXER : public DSNLEXER
{
...
public:
     ...
     */
    DRCRULE_T::T GetCurStrAsToken()
    {
        return (DRCRULE_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
