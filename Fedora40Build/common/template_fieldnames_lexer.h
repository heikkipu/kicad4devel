 ...
 *    /opt/kicad/program/master/Tears_Master/common/template_fieldnames.keywords
 */
class KICOMMON_API TEMPLATE_FIELDNAMES_LEXER : public DSNLEXER
{
...
public:
     ...
     */
    TFIELD_T::T GetCurStrAsToken()
    {
        return (TFIELD_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
