 ...
 *    /opt/kicad/program/master/Tears_Master/common/netlist.keywords
 */
class KICOMMON_API NETLIST_LEXER : public DSNLEXER
{
...
public:
    ...
    NL_T::T PrevTok()
    {
        return (NL_T::T) DSNLEXER::PrevTok();
    }
     ...
     */
    NL_T::T GetCurStrAsToken()
    {
        return (NL_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
 ...
 *
class NETLIST_PARSER : public NETLIST_LEXER
{

};
*/

#endif   // NETLIST_LEXER_H_
