...
#ifndef LIB_TABLE_LEXER_H_
#define LIB_TABLE_LEXER_H_
 ...
 *   typedef LIB_TABLE_T::T T;
 * within that problem area.
 */
namespace LIB_TABLE_T
{
 ...
 *    /opt/kicad/program/master/Tears_Master/common/lib_table.keywords
 */
class KICOMMON_API LIB_TABLE_LEXER : public DSNLEXER
{
...
public:
     ...
     * with another usage).
     * @return LIB_TABLE_T::T - the type of token found next.
     * @throw IO_ERROR - only if the LINE_READER throws it.
     */
    LIB_TABLE_T::T NextTok()
    {
        return (LIB_TABLE_T::T) DSNLEXER::NextTok();
    }
    ...
    {
        return (LIB_TABLE_T::T) DSNLEXER::NeedSYMBOL();
    }
    ...
    {
        return (LIB_TABLE_T::T) DSNLEXER::NeedSYMBOLorNUMBER();
    }
    ...
    {
        return (LIB_TABLE_T::T) DSNLEXER::CurTok();
    }
    ...
    {
        return (LIB_TABLE_T::T) DSNLEXER::PrevTok();
    }
     ...
     */
    LIB_TABLE_T::T GetCurStrAsToken()
    {
        return (LIB_TABLE_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
 ...
 *
class LIB_TABLE_PARSER : public LIB_TABLE_LEXER
{

};
*/

#endif   // LIB_TABLE_LEXER_H_
