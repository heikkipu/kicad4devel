...
#ifndef DIALOG_BOM_CFG_LEXER_H_
#define DIALOG_BOM_CFG_LEXER_H_
 ...
 *   typedef T_BOMCFG_T::T T;
 * within that problem area.
 */
namespace T_BOMCFG_T
{
 ...
 *    /opt/kicad/program/master/Tears_Master/eeschema/dialogs/dialog_bom_cfg.keywords
 */
...
public:
     ...
     * with another usage).
     * @return T_BOMCFG_T::T - the type of token found next.
     * @throw IO_ERROR - only if the LINE_READER throws it.
     */
    T_BOMCFG_T::T NextTok()
    {
        return (T_BOMCFG_T::T) DSNLEXER::NextTok();
    }
    ...
    {
        return (T_BOMCFG_T::T) DSNLEXER::NeedSYMBOL();
    }
    ...
    {
        return (T_BOMCFG_T::T) DSNLEXER::NeedSYMBOLorNUMBER();
    }
    ...
    T_BOMCFG_T::T CurTok()
    {
        return (T_BOMCFG_T::T) DSNLEXER::CurTok();
    }
    ...
    {
        return (T_BOMCFG_T::T) DSNLEXER::PrevTok();
    }
     ...
     */
    T_BOMCFG_T::T GetCurStrAsToken()
    {
        return (T_BOMCFG_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
 ...
 *
class DIALOG_BOM_CFG_PARSER : public DIALOG_BOM_CFG_LEXER
{

};
*/

#endif   // DIALOG_BOM_CFG_LEXER_H_
