...
#ifndef PCB_CALCULATOR_DATAFILE_LEXER_H_
#define PCB_CALCULATOR_DATAFILE_LEXER_H_
 ...
 *   typedef PCBCALC_DATA_T::T T;
 * within that problem area.
 */
namespace PCBCALC_DATA_T
{
 ...
 *    /opt/kicad/program/master/Tears_Master/pcb_calculator/pcb_calculator_datafile.keywords
 */
...
public:
     ...
     */
    PCB_CALCULATOR_DATAFILE_LEXER( const std::string& aSExpression, const wxString& aSource = wxEmptyString ) :
     ...
     */
    PCB_CALCULATOR_DATAFILE_LEXER( FILE* aFile, const wxString& aFilename ) :
     ...
     */
    PCB_CALCULATOR_DATAFILE_LEXER( LINE_READER* aLineReader ) :
     ...
     */
    static const char* TokenName( PCBCALC_DATA_T::T aTok );
     ...
     */
    PCBCALC_DATA_T::T CurTok()
    {
        return (PCBCALC_DATA_T::T) DSNLEXER::CurTok();
    }
     ...
     */
    PCBCALC_DATA_T::T PrevTok()
    {
        return (PCBCALC_DATA_T::T) DSNLEXER::PrevTok();
    }
     ...
     */
    PCBCALC_DATA_T::T GetCurStrAsToken()
    {
        return (PCBCALC_DATA_T::T) DSNLEXER::GetCurStrAsToken();
    }
};
...
#endif   // PCB_CALCULATOR_DATAFILE_LEXER_H_
