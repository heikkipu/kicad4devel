...
public:
    ...
    TrackNodeItem::TEARDROP* Add( const TRACK* aTrackSegTo,
    ...
    TrackNodeItem::TEARDROP* Add( const TRACK* aTrackSegTo,
                                  ...
                                  const wxPoint aPosition = wxPoint( 0,0 ) ); //Add vias or pads one track segment.
    ...
    void Remove( const int aNetCodeFrom,
    ...
    //Plot.
    void Plot( const TrackNodeItem::TRACKNODEITEM* aTrackNodeItem,
               PLOTTER* aPlotter,
...
private:
    //Creation
    TrackNodeItem::TEARDROP* Create( const TRACK* aTrackSegTo,
                                     const BOARD_CONNECTED_ITEM* aViaOrPadTo,
                                     const bool aNullTrackCheck,
                                     const wxPoint aPosition = wxPoint( 0,0 ) );
    //Removing
    void Delete( TrackNodeItem::TEARDROP* aTeardrop,
                 DLIST<TRACK>*aTrackListAt,
                 PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    void Remove( TrackNodeItem::TEARDROP* aTeardrop,
                 PICKED_ITEMS_LIST* aUndoRedoList,
                 const bool aSaveRemoved,
                 const bool aLockedToo );

    void Remove( const VIA* aViaFrom,
                 PICKED_ITEMS_LIST* aUndoRedoList,
                 const bool aSaveRemoved,
                 const bool aLockedToo );

    void Remove( const D_PAD* aPadFrom,
                 PICKED_ITEMS_LIST* aUndoRedoList,
                 const bool aSaveRemoved,
                 const bool aLockedToo );
...
public:
    ...
    void UpdateRouteEdit( EDA_DRAW_PANEL* aPanel,
                          wxDC* aDC,
                          const TRACK* aTrack,
                          const unsigned int aViaRad,
                          const bool aErase,
                          bool* aTrack45Only );
...
private:
    ...
    {
    public:
        NET_SCAN_GET_TEARDROP( const TRACK* aTrackSeg,
    ...
    {
    public:
        NET_SCAN_TRACK_DRAW_UPDATE( const TRACK* aTrackSeg,
                                    const TEARDROPS* aParent,
...
//-----------------------------------------------------------------------------------------------------/
    ...
    {
    public:
        NET_SCAN_VIA_REMOVE( const VIA* aVia,
                             const TEARDROPS* aParent,
                             PICKED_ITEMS_LIST* aUndoRedoList,
    ...
    {
    public:
        NET_SCAN_VIA_COLLECTCOMMIT( const VIA* aVia,
                                    const TEARDROPS* aParent,
...
//-----------------------------------------------------------------------------------------------------/
    ...
    {
    public:
        NET_SCAN_PAD_REMOVE( const D_PAD* aPad,
                             const TEARDROPS* aParent,
                             PICKED_ITEMS_LIST* aUndoRedoList,
                             Teardrop_Container* aRecreateList,
                             const bool aLockedToo );
    ...
    {
    public:
        NET_SCAN_PAD_RECREATE( const D_PAD* aPad,
                               const TEARDROPS* aParent,
                               PICKED_ITEMS_LIST* aUndoRedoList,
                               Teardrop_Container* aRecreateList );
    ...
    {
    public:
        NET_SCAN_PAD_COLLECTCOMMIT( const D_PAD* aPad,
                                    const TEARDROPS* aParent,
                                    std::set<TRACK*>* aCommitContainer,
                                    const bool aLockedToo );
...
//-----------------------------------------------------------------------------------------------------/
    ...
    {
    protected:
        TEARDROPS_MODULES_PROGRESS( const TEARDROPS* aParent,
...
//-----------------------------------------------------------------------------------------------------/
    ...
    {
    public:
        MODULES_PROGRESS_ADD_TEARS( const TEARDROPS* aParent,
                                    const DLIST<MODULE>* aModules,
                                    PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        MODULES_PROGRESS_REMOVE_TEARS( const TEARDROPS* aParent,
                                       const DLIST<MODULE>* aModules,
                                       PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        MODULES_PROGRESS_CHANGE_TEARS( const TEARDROPS* aParent,
                                       const DLIST<MODULE>* aModules,
    ...
    {
    public:
        MODULES_PROGRESS_MARK_WARNINGS( const TEARDROPS* aParent,
                                        const DLIST<MODULE>* aModules,
                                        DRC* aDRC );
...
//-----------------------------------------------------------------------------------------------------/
    ...
    {
    protected:
        TEARDROPS_TRACKS_PROGRESS( const TEARDROPS* aParent,
    ...
    {
    public:
        TRACKS_PROGRESS_ADD_TEARS_VIAS( const TEARDROPS* aParent,
                                        const DLIST<TRACK>* aTracks,
                                        PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_REMOVE_TEARS_VIAS( const TEARDROPS* aParent,
                                           const DLIST<TRACK>* aTracks,
                                           PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_CHANGE_TEARS_VIAS( const TEARDROPS* aParent,
                                           const DLIST<TRACK>* aTracks,
                                           PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_ADD_TJUNCTIONS( const TEARDROPS* aParent,
                                        const DLIST<TRACK>* aTracks,
                                        PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_REMOVE_TJUNCTIONS( const TEARDROPS* aParent,
                                           const DLIST<TRACK>* aTracks,
                                           PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    class TRACKS_PROGRESS_CHANGE_TJUNCTIONS : public TRACKS_PROGRESS_CHANGE_TEARS_VIAS,
                                              public TRACKS_PROGRESS_REMOVE_TJUNCTIONS
    {
    public:
        TRACKS_PROGRESS_CHANGE_TJUNCTIONS( const TEARDROPS* aParent,
                                           const DLIST<TRACK>* aTracks,
                                           PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_ADD_JUNCTIONS( const TEARDROPS* aParent,
                                       const DLIST<TRACK>* aTracks,
                                       PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_REMOVE_JUNCTIONS( const TEARDROPS* aParent,
                                          const DLIST<TRACK>* aTracks,
                                          PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    class TRACKS_PROGRESS_CHANGE_JUNCTIONS : public TRACKS_PROGRESS_CHANGE_TEARS_VIAS,
                                             public TRACKS_PROGRESS_REMOVE_JUNCTIONS
    {
    public:
        TRACKS_PROGRESS_CHANGE_JUNCTIONS( const TEARDROPS* aParent,
                                          const DLIST<TRACK>* aTracks,
                                          PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_MARK_WARNINGS( const TEARDROPS* aParent,
                                       const DLIST<TRACK>* aTracks,
                                       const TEARDROPS::TEARDROPS_TYPE_TODO aTypeToDo,
                                       DRC* aDRC );
    ...
    {
    public:
        TRACKS_PROGRESS_MARK_DIFF( const TEARDROPS* aParent,
                                   const DLIST<TRACK>* aTracks,
                                   const TEARDROPS::TEARDROPS_TYPE_TODO aTypeToDo,
                                   DRC* aDRC );
    ...
    {
    public:
        TRACKS_PROGRESS_MARK_CURR( const TEARDROPS* aParent,
                                   const DLIST<TRACK>* aTracks,
                                   const TEARDROPS::TEARDROPS_TYPE_TODO aTypeToDo,
                                   DRC* aDRC );
    ...
    {
    public:
        TRACKS_PROGRESS_CLEAN( const TEARDROPS* aParent,
                               const DLIST<TRACK>* aTracks,
                               PICKED_ITEMS_LIST* aUndoRedoList );
    ...
    {
    public:
        TRACKS_PROGRESS_LOCK_SAME( const TEARDROPS* aParent,
                                   const DLIST<TRACK>* aTracks,
                                   const TrackNodeItem::TEARDROP::PARAMS aParams );
    ...
    {
    public:
        TRACKS_PROGRESS_UNLOCK_SAME( const TEARDROPS* aParent,
                                     const DLIST<TRACK>* aTracks,
                                     const TrackNodeItem::TEARDROP::PARAMS aParams );
