...
ROUNDEDTRACKSCORNERS::ROUNDEDTRACKSCORNERS_PROGRESS_ADD_CORNERS::ROUNDEDTRACKSCORNERS_PROGRESS_ADD_CORNERS(
...
ROUNDEDTRACKSCORNERS::ROUNDEDTRACKSCORNERS_PROGRESS_CONVERT_TRACKS::ROUNDEDTRACKSCORNERS_PROGRESS_CONVERT_TRACKS(
    const ROUNDEDTRACKSCORNERS* aParent,
    const DLIST<TRACK>* aTracks,
    PICKED_ITEMS_LIST* aUndoRedoList
) :
...
// Clean
//-----------------------------------------------------------------------------------------------------/
ROUNDEDTRACKSCORNERS::ROUNDEDTRACKSCORNERS_PROGRESS_CLEAN::ROUNDEDTRACKSCORNERS_PROGRESS_CLEAN(
    const ROUNDEDTRACKSCORNERS* aParent,
    const DLIST<TRACK>* aTracks,
    PICKED_ITEMS_LIST* aUndoRedoList
) :
